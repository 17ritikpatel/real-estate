    ...
    <div>
      <div className={`${darkMode ? 'dark bg-black' : 'light bg-white'}`}>
        <section id='hero' className='w-[95%] h-[600px] m-auto bg-cover bg-center rounded-xl flex justify-center flex-col items-start lg:px-28 px-10 gap-7 z-20' style={{ backgroundImage: `url(${heroimg})` }}>
          ...
          <p data-aos="zoom-in" className='text-white text-xl lg:pr-[500px] pr-0'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nihil tenetur corporis quis repellendus nulla nobis ratione aut architecto eligendi officiis.</p>
...
<div className='w-full'>
<button className='bg-red-600 dark:bg-red-700 hover:bg-red-900 dark:hover:bg-white dark:hover:text-black text-lg p-4 w-full text-white font-semibold rounded-xl cursor-pointer transform hover:scale-110 transition-transform duration-300'>SUBMIT</button>
</div>
